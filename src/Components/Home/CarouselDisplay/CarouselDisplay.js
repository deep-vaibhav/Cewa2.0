        ...
        <Row className="img_container">
          ...
          <div className="BannerText">
            ...
            <motion.p
              ...
              transition={{ ease: "easeOut", duration: 1 }}
            >
              Every child deserves a chance at life, the right to follow their
              dreams, an opportunity to embrace their potential, and some
              humanity, and care. Therefore, every child must be treated fair.
              If we stand up for the impoverished children, we stand for a
              better society, a better tomorrow, and a brighter future.
            </motion.p>
            <motion.a href="/Events" whileHover={{ scale: 1.05, y: -4 }}>
              EXPLORE
            </motion.a>
          </div>
        </Row>
